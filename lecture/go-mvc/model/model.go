...
func (p *Model) GetNamePerson(n string){
...
func (p *Model) GetPnumPerson(pn string){
...
func (p *Model) PostNewperson(na, pn string) {
	
}

func (p *Model) DeletePnump(pn string) {
	filter := bson.D{{ "pnum", pn }}
...
func (p *Model) PutPnumAge(pn string, ag int) {
	filter := bson.D{{ "pnum", pn }}
